...
import com.example.myapplication.account.teacher.ui.slideshow.TeacherDetailsistAdapter;

import java.util.ArrayList;
import java.util.List;

public class TeacherListStFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View root = inflater.inflate(R.layout.fragment_student_slideshow, container, false);
        ...
        teacherListViewModel.getModels().observe(this, new Observer<List<TeacherModel>>() {
            @Override
